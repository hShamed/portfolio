  ...
  return (
    <nav className={styles.navbar}>
      ...
      <ul className={styles.navbarIcons}>
        <ThemeSwitcher />
        <li className={styles.navbarItem}>
          <a href="#" className={styles.navbarLink} target="_blank">
            <DocumentTextIcon className={styles.logo} />
          </a>
        </li>
        <li className={styles.navbarItem}>
          <a
            href="https://github.com/hShamed"
          ...
          >
            <svg
              ...
              viewBox="0 0 496 512"
              className={`${styles.logo} ${styles.svg}`}
            >
        ...
        <li className={styles.navbarItem}>
          <a
            href="https://www.linkedin.com/in/h-shamed-ar/"
            className={styles.navbarLink}
            target="_blank"
          >
            <svg
